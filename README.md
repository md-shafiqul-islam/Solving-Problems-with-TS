...
i) Declaration Merging
	. Interface-কে আমরা একাধিকবার declare করতে পারি এবং TypeScript তাদের একত্রিত করে।
	. Type alias-কে একবার declare করার পর আবার declare করলে error দেয়।
ii) Extending / Implementing
	. Interface সহজে extend করা যায়, class implement করতে পারে।
	. Type alias থেকে extend করা যায়, কিন্তু class implement করতে হলে interface ব্যবহার বেশি প্রাকটিক্যাল।
iii) Complex Types
	. Interface মূলত অবজেক্ট বা class এর structure define করার জন্য।
	. Type alias দিয়ে union, intersection, tuple, primitive সব ধরনের type বানানো যায়।
